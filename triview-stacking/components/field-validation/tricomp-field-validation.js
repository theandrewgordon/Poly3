...
class FieldValidationComponent extends PolymerElement {
	static get is() { return "tricomp-field-validation"; }
	...
	static get importMeta() {
		return getModuleUrl("triview-stacking/components/field-validation/tricomp-field-validation.js");
	}
}

window.customElements.define(FieldValidationComponent.is, FieldValidationComponent);