...
class ForgeModelDetail extends PolymerElement 
{
  static get template() {
   return html`
        <style>
        ...
        <paper-dialog id="dialog" modal="">
            ...
            <paper-dialog-scrollable>
                ...
                <iron-pages selected="{{model.activeTab}}">
                    ...
                    <div>
                        ...
                        <div style="display:inline;">
                            ...
                            <span style="padding-left:10px;">{{model.size}}</span>
                              <paper-icon-button icon="delete-forever" on-click="_deleteModel" class="icons" alt="Delete model" style="float:right">
                              </paper-icon-button>
                        </div>
                    </div>
                    ...
                    <template is="dom-if" if="{{model.hasBubble}}">
                        <table>
                            <tbody><tr><td colspan="6"><h4 class="label">Base 64 Urn:</h4></td></tr>
                    ...
                    <template is="dom-if" if="[[model.hasProject">
                        <template is="dom-if" if="[[!model.projectInfo.dwgVersion]]">
                            <table>
                                <tbody><tr><td>Author</td><td>					  </td><td>[[model.projectInfo.author]]</td></tr>          
                                <tr><td>Building Name</td><td>			  </td><td>[[model.projectInfo.buildingName]]</td></tr>    
                                <tr><td>Client Name</td><td>			  </td><td>[[model.projectInfo.clientName]]</td></tr>
                                <tr><td>Organization Description</td><td> </td><td>[[model.projectInfo.orgDesc]]</td></tr>
                                <tr><td>Organization Name</td><td>		  </td><td>[[model.projectInfo.orgName]]</td></tr>
                                <tr><td>Project Address</td><td>		  </td><td>[[model.projectInfo.projectAddress]]</td></tr>
                                <tr><td>Project Issue Date</td><td>		  </td><td>[[model.projectInfo.issueData]]</td></tr>
                                <tr><td>Project Name</td><td>			  </td><td>[[model.projectInfo.projectName]]</td></tr>
                                <tr><td>Project Number</td><td>			  </td><td>[[model.projectInfo.projectNum]]</td></tr>
                                <tr><td>Project Status</td><td>			  </td><td>[[model.projectInfo.projectStatus]]</td></tr>
                            </tbody></table>
                        </template>
                        <template is="dom-if" if="[[model.projectInfo.dwgVersion]]">
                            <table>
                                <tbody><tr><td>DWGVersion</td><td>		</td><td>[[model.projectInfo.dwgVersion]]</td><td>
                                </td></tr><tr><td>Date Created</td><td>	</td><td>[[model.projectInfo.dateCreated]]</td><td>
                                </td></tr><tr><td>FileSize</td><td>		</td><td>[[model.projectInfo.fileSize]]</td><td>
                                </td></tr><tr><td>Last Write</td><td>		</td><td>[[model.projectInfo.lasWrite]]</td><td>
                                </td></tr><tr><td>Name</td><td>			</td><td>[[model.projectInfo.name]]</td><td>
                            </td></tr></tbody></table>
                        </template>
                    </template>
                </iron-pages>
