...
class ForgeViewable extends PolymerElement 
{
  static get template() {
    return html`
        <style>
        ...
        <app-drawer-layout id="drawerPanel"> 
            ...
            <app-header-layout style="height:100%; ">
                <forge-scroll-pane id="viewerScrollPane" on-set-size="setSize" style="--forge-scroll-pane-overflow:none;">
                    ...
                    <forge-viewer id="viewer" ,="" urn="{{urn}}" contextroot="[[contextroot]]" authurl="[[restpath]]" features="[[features]]" locale="[[locale]]" on-select="onSelect">
                      </forge-viewer>
                </forge-scroll-pane>
            </app-header-layout>
        </app-drawer-layout> 
