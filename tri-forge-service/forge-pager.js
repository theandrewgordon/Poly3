...
class ForgePager extends PolymerElement 
{
  static get template() {
   return html`
        <style>
        ...
        <div class="pager">
            ...
            <div class="pagesize">
                <paper-input-container floatinglabel="" class="pagesize">
                    ...
                    <input id="pageSize" slot="input" type="number" min="2" max="[[maxpagesize]]" size="3" value="{{pagesize}}" required="" class="paper-input-input" on-change="_pageSizeChange">
