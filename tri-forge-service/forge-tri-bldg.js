...
import './forge-viewable-sidebar.js';
import './forge-tri-bldg-storage.js';
import './forge-tri-bldg-model-lookup.js';
import { getModuleUrl  } from '../tricore-util/tricore-util.js';
class ForgeTriBldg extends PolymerElement 
{
  static get template() {
    return html`
        <style>
        ...
        <forge-tri-bldg-model-lookup id="lookup" list="[[modellist]]" modelmanager="[[modelmanager]]" on-accept="_onModelSelect">
        ...
        <forge-scroll-pane id="scrollPane" style="--forge-scroll-pane-overflow:auto;" on-next-page="_getNextPage">
            <template id="repeat" is="dom-repeat" items="[[buildinglist]]">
                 <div class="card-body">
                    <div class="card-title">
                        <h3>[[item.building]]</h3>
                        <div style="width:100%; display: inline-flex;">
                            <paper-input floatinglabel="" label="Building Model" style="width:100%;" value="[[item.objectKey]]" readonly=""></paper-input>
                        </div>
                        <div class="search">
        ...
        <forge-tri-bldg-storage id="storage" contextroot="[[contextroot]]" on-building-list="_onBuildingList" on-link-add="_onLinkAdd" on-model-link="_onLink" on-link-update="_onLinkAdd" on-link-delete="_unlinkModel">
...
`;
 ...
 static get importMeta() {
    return getModuleUrl("tri-forge-service/forge-tri-bldg.js");
  }
}
