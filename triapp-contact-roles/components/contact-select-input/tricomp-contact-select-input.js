...
import "./tricomp-contact-select-input-dropdown.js"

class ContactSelectInputComponent extends TrimixinDropdownComponent(PolymerElement) {
	static get is() { return "tricomp-contact-select-input"; }
	...
	static get template() {
		return html`
			...
			<template id="dropdownTemplate">
				<tricomp-contact-select-input-dropdown id="tricomp-contact-select-input-dropdown"></tricomp-contact-select-input-dropdown>
			</template>
		`;
	}
	...
	_observeValue(value) {
		this._getDropdown().updateValue(value);
	}
	...
	_onInputTapped(e) {
		...
		this.set('scroller', this._getDropdown().scroller);
		setTimeout(() => {
	...
	static get importMeta() {
		return getModuleUrl("triapp-contact-roles/components/contact-select-input/tricomp-contact-select-input.js");
	}
}

window.customElements.define(ContactSelectInputComponent.is, ContactSelectInputComponent);